...
*Небольшая предыстория. Этот пост я писал для двух целей. Во-первых, чтобы проиллюстрировать, как можно написать текст в разметке Markdown + $\LaTeX$, а потом перегнать его к хабрачитаемому виду. Во-вторых, рассказать об интересной задаче из data streaming. Первое получилось, а со вторым вышла накладка. К концу написания, я обнаружил [пост про LogLog](http://habrahabr.ru/post/119852/) четырехлетней давности. На мою удачу автор предыдущего поста делал упор на реализацию. Я же, полагаясь на $\LaTeX$, расскажу больше о математике этой задачи.*
